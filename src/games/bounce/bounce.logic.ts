...
export const LEVELS: Level[] = [
  ...
  // Level 4: The Spike Gauntlet
  {
    ...
    blocks: [
      ...
      { x: 1800, y: 160, width: 60, height: 15, isBouncy: true },
      { x: 2050, y: 220, width: 220, height: 20 },
    ],
    slopes: [],
    checkpoints: [
      { x: 450, y: 350, active: false }, // Ground 1
      { x: 1150, y: 350, active: false }, // Ground 2
      { x: 2150, y: 350, active: false }, // Ground 4 y:350
    ],
    spikes: [
    ...
    rings: [
      ...
      { x: 1720, y: 120, radius: 10, collected: false },
      { x: 1830, y: 60, radius: 10, collected: false },
  ...
  // Level 7: Canopy Leap (Forest Treetops)
  {
    width: 2600,
    startPos: { x: 80, y: 300 },
    blocks: [
      { x: 0, y: 350, width: 400, height: 50 },
      { x: 500, y: 350, width: 400, height: 50 },
      { x: 1000, y: 350, width: 500, height: 50 },
      { x: 1600, y: 350, width: 400, height: 50 },
      { x: 2100, y: 350, width: 500, height: 50 },
      // Floating challenges
      { x: 300, y: 260, width: 80, height: 20 },
      { x: 420, y: 200, width: 60, height: 15, isBouncy: true },
      { x: 580, y: 180, width: 100, height: 20 },
      { x: 750, y: 240, width: 100, height: 20 },
      { x: 920, y: 170, width: 60, height: 15, isBouncy: true },
      { x: 1100, y: 120, width: 150, height: 20 },
      { x: 1350, y: 220, width: 100, height: 20 },
      { x: 1500, y: 160, width: 60, height: 15, isBouncy: true },
      { x: 1700, y: 220, width: 120, height: 20 },
      { x: 1900, y: 180, width: 60, height: 15, isBouncy: true },
      { x: 2100, y: 240, width: 150, height: 20 },
    ],
    slopes: [],
    checkpoints: [
      { x: 250, y: 350, active: false },
      { x: 750, y: 350, active: false },
      { x: 1250, y: 350, active: false },
      { x: 1850, y: 350, active: false },
    ],
    spikes: [
      { x: 400, y: 350, width: 100, height: 50 },
      { x: 900, y: 350, width: 100, height: 50 },
      { x: 1500, y: 350, width: 100, height: 50 },
      { x: 2000, y: 350, width: 100, height: 50 },
    ],
    rings: [
      { x: 340, y: 200, radius: 10, collected: false },
      { x: 450, y: 100, radius: 10, collected: false },
      { x: 630, y: 120, radius: 10, collected: false },
      { x: 800, y: 180, radius: 10, collected: false },
      { x: 950, y: 80, radius: 10, collected: false },
      { x: 1180, y: 60, radius: 10, collected: false },
      { x: 1400, y: 160, radius: 10, collected: false },
      { x: 1530, y: 80, radius: 10, collected: false },
      { x: 1760, y: 160, radius: 10, collected: false },
      { x: 1930, y: 90, radius: 10, collected: false },
      { x: 2170, y: 180, radius: 10, collected: false },
    ],
    exitPortal: { x: 2450, y: 290, width: 35, height: 60 },
  },
  // Level 8: Spike Corridor (Precise maneuvers)
  {
    width: 2800,
    startPos: { x: 80, y: 300 },
    blocks: [
      ...
      { x: 1650, y: 270, width: 100, height: 20 },
      { x: 1800, y: 210, width: 60, height: 15, isBouncy: true },
      { x: 1950, y: 160, width: 120, height: 20 },
      { x: 2350, y: 260, width: 150, height: 20 },
    ],
    slopes: [],
    checkpoints: [
      { x: 500, y: 350, active: false },
      { x: 1000, y: 350, active: false },
      { x: 1700, y: 350, active: false },
      { x: 2400, y: 350, active: false },
    ],
    spikes: [
      { x: 600, y: 350, width: 150, height: 50 },
      { x: 1350, y: 350, width: 150, height: 50 },
      { x: 2100, y: 350, width: 100, height: 50 },
      { x: 340, y: 265, width: 20, height: 15 },
      { x: 950, y: 245, width: 20, height: 15 },
      { x: 1700, y: 255, width: 20, height: 15 },
    ],
    rings: [
      { x: 350, y: 230, radius: 10, collected: false },
      { x: 500, y: 170, radius: 10, collected: false },
      { x: 650, y: 230, radius: 10, collected: false },
      { x: 960, y: 210, radius: 10, collected: false },
      { x: 1160, y: 150, radius: 10, collected: false },
      { x: 1360, y: 210, radius: 10, collected: false },
      { x: 1830, y: 100, radius: 10, collected: false },
      { x: 2010, y: 110, radius: 10, collected: false },
      { x: 2420, y: 200, radius: 10, collected: false },
    ],
    exitPortal: { x: 2650, y: 290, width: 35, height: 60 },
  },
  // Level 9: Ring Heaven (Multi-tier collecting)
  {
    width: 3000,
    startPos: { x: 80, y: 300 },
    blocks: [
      { x: 0, y: 350, width: 800, height: 50 },
      { x: 950, y: 350, width: 800, height: 50 },
      { x: 1900, y: 350, width: 1100, height: 50 },
      // Upper tier bouncy elevator
      { x: 400, y: 250, width: 120, height: 20 },
      { x: 600, y: 180, width: 60, height: 15, isBouncy: true },
      { x: 750, y: 120, width: 150, height: 20 },
      { x: 1000, y: 120, width: 150, height: 20 },
      { x: 1250, y: 180, width: 60, height: 15, isBouncy: true },
      { x: 1400, y: 240, width: 150, height: 20 },
      { x: 1650, y: 180, width: 150, height: 20 },
      { x: 1900, y: 140, width: 60, height: 15, isBouncy: true },
      { x: 2100, y: 200, width: 200, height: 20 },
      { x: 2400, y: 260, width: 200, height: 20 },
    ],
    slopes: [],
    checkpoints: [
      { x: 300, y: 350, active: false },
      { x: 1200, y: 350, active: false },
      { x: 2000, y: 350, active: false },
      { x: 2600, y: 350, active: false },
    ],
    spikes: [
      { x: 800, y: 350, width: 150, height: 50 },
      { x: 1750, y: 350, width: 150, height: 50 },
    ],
    rings: [
      { x: 460, y: 190, radius: 10, collected: false },
      { x: 630, y: 100, radius: 10, collected: false },
      { x: 825, y: 60, radius: 10, collected: false },
      { x: 1075, y: 60, radius: 10, collected: false },
      { x: 1280, y: 100, radius: 10, collected: false },
      { x: 1480, y: 180, radius: 10, collected: false },
      { x: 1725, y: 120, radius: 10, collected: false },
      { x: 1930, y: 60, radius: 10, collected: false },
      { x: 2200, y: 140, radius: 10, collected: false },
      { x: 2500, y: 200, radius: 10, collected: false },
    ],
    exitPortal: { x: 2850, y: 290, width: 35, height: 60 },
  },
  // Level 10: The Grand Finale (Endurance challenge)
  {
    width: 3600,
    startPos: { x: 80, y: 300 },
    blocks: [
      { x: 0, y: 350, width: 500, height: 50 },
      { x: 650, y: 350, width: 500, height: 50 },
      { x: 1300, y: 350, width: 500, height: 50 },
      { x: 1950, y: 350, width: 500, height: 50 },
      { x: 2600, y: 350, width: 1000, height: 50 },
      // Tier 1 jumps
      { x: 220, y: 250, width: 100, height: 20 },
      { x: 380, y: 180, width: 100, height: 20 },
      { x: 520, y: 180, width: 60, height: 15, isBouncy: true },
      { x: 750, y: 240, width: 120, height: 20 },
      { x: 950, y: 180, width: 120, height: 20 },
      { x: 1120, y: 140, width: 60, height: 15, isBouncy: true },
      // Middle high section
      { x: 1350, y: 200, width: 120, height: 20 },
      { x: 1520, y: 140, width: 120, height: 20 },
      { x: 1700, y: 140, width: 60, height: 15, isBouncy: true },
      { x: 1850, y: 220, width: 100, height: 20 },
      // Final Ascent
      { x: 2100, y: 250, width: 100, height: 20 },
      { x: 2280, y: 190, width: 100, height: 20 },
      { x: 2420, y: 140, width: 60, height: 15, isBouncy: true },
      { x: 2650, y: 220, width: 150, height: 20 },
      { x: 2850, y: 160, width: 150, height: 20 },
      { x: 3050, y: 100, width: 120, height: 20 },
      { x: 3220, y: 180, width: 150, height: 20 },
    ],
    slopes: [],
    checkpoints: [
      { x: 250, y: 350, active: false },
      { x: 900, y: 350, active: false },
      { x: 1550, y: 350, active: false },
      { x: 2200, y: 350, active: false },
      { x: 2800, y: 350, active: false },
      { x: 3200, y: 350, active: false },
    ],
    spikes: [
      { x: 500, y: 350, width: 150, height: 50 },
      { x: 1150, y: 350, width: 150, height: 50 },
      { x: 1800, y: 350, width: 150, height: 50 },
      { x: 2450, y: 350, width: 150, height: 50 },
      { x: 800, y: 335, width: 60, height: 15 },
      { x: 1400, y: 335, width: 60, height: 15 },
      { x: 2050, y: 335, width: 60, height: 15 },
      { x: 2950, y: 335, width: 60, height: 15 },
    ],
    rings: [
      { x: 270, y: 190, radius: 10, collected: false },
      { x: 430, y: 120, radius: 10, collected: false },
      { x: 550, y: 80, radius: 10, collected: false },
      { x: 810, y: 180, radius: 10, collected: false },
      { x: 1010, y: 120, radius: 10, collected: false },
      { x: 1150, y: 60, radius: 10, collected: false },
      { x: 1410, y: 140, radius: 10, collected: false },
      { x: 1730, y: 60, radius: 10, collected: false },
      { x: 2150, y: 190, radius: 10, collected: false },
      { x: 2330, y: 130, radius: 10, collected: false },
      { x: 2450, y: 60, radius: 10, collected: false },
      { x: 2725, y: 160, radius: 10, collected: false },
      { x: 2925, y: 100, radius: 10, collected: false },
      { x: 3110, y: 40, radius: 10, collected: false },
      { x: 3295, y: 120, radius: 10, collected: false },
    ],
    exitPortal: { x: 3450, y: 290, width: 35, height: 60 },
  }
];
